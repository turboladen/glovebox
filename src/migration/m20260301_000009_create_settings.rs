        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Settings::CreatedAt).text().not_null().default(Expr::cust("(datetime('now'))")))
                    .col(ColumnDef::new(Settings::UpdatedAt).text().not_null().default(Expr::cust("(datetime('now'))")))
                    .to_owned(),
            )
            .await
    }
